...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">اهلا {{ auth()->user()->name }}, مرحبا بعودتك</h2>
            <p class="mg-b-0">نعرض ااحصائيات العامة في هذه الصفحه.</p>
        </div>
    </div>
                    ...
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(App\Models\Invoice::all()->sum('total'), 2) }} EGP
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">اجمالي عدد الفواتير :
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(App\Models\Invoice::where('value_status', 2)->sum('total'), 2) }} EGP
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">اجمالي عدد الفواتير :
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white op-7">
                                {{ round(App\Models\Invoice::where('value_status', 2)->count() / App\Models\Invoice::count() * 100) }}%</span>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(App\Models\Invoice::where('value_status', 1)->sum('total'), 2) }} EGP
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">اجمالي عدد الفواتير :
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(App\Models\Invoice::where('value_status', 3)->sum('total'), 2) }} EGP
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">اجمالي عدد الفواتير :
                        ...
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
                            <span class="text-white op-7">
                                {{ round(App\Models\Invoice::where('value_status', 3)->count() / App\Models\Invoice::count() * 100) }}%</span>
                        </span>
                    </div>
                </div>
            </div>
