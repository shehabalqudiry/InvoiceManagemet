                ...
                <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        <div class="col-lg">
                            ...
                            <input class="form-control" placeholder="رقم الفاتورة" type="text" value="{{ old('invoice_number') }}" name="invoice_number">
                        </div>
                        <div class="col-lg">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    ...
                                    <input class="form-control" id="datetimepicker" type="text" name="invoice_date"
                                        value="{{ old('invoice_date') ? old('invoice_date') : date('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-lg">
                            <label>تاريخ الاستحقاق</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="datetimepicker2" type="text" name="due_date" value="{{ old('due_date') ? old('due_date') : date('Y-m-d') }}">
                                </div>
                        </div>
                    </div>
                    <div class="row row-sm mg-t-20">
                        ...
                        <div class="col-lg">
                            ...
                            <input class="form-control" value="{{ old('amount_collection') }}" placeholder="مبلغ التحصيل" type="text" id="amount_collection" name="amount_collection">
                        </div>
                    </div>
                    <div class="row row-sm mg-t-20">
                        <div class="col-lg">
                            <label>مبلغ العمولة</label>
                            <input class="form-control" value="{{ old('amount_commission') ? old('amount_commission') : '' }}" placeholder="مبلغ العمولة" type="text" id="amount_commission" name="amount_commission">
                        </div>
                        <div class="col-lg">
                            <label>الخصم</label>
                            <input class="form-control" value="{{ old('discount') ? old('discount') : '0' }}" placeholder="الخصم" type="text" id="discount" name="discount">
                        </div>
                        <div class="col-lg">
                    ...
                    <div class="row row-sm mg-t-20">
                        <div class="col-lg">
                            <label>ملاحظات</label>
                            <textarea class="form-control" placeholder="وصف الفاتورة" rows="3" id="note" name="note">{{ old('note') }}</textarea>
                        </div>
                    </div>
                    <div class="row row-sm mg-t-20">
                        <div class="col-lg">
