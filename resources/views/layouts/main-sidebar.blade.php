				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@endcan
							@can('invoice-part_paid')
                            <li><a class="slide-item" href="{{ route('invoices.part_paid') }}">الفواتير المدفوعه جزئيا</a></li>
							@endcan
							@can('invoice-unpaid')
                            <li><a class="slide-item" href="{{ route('invoices.unpaid') }}">الفواتير الغير مدفوعة</a></li>
							@endcan
							@can('invoice-archive')
                            <li><a class="slide-item" href="{{ route('invoices.archivePage') }}">أرشيف الفواتير</a></li>
                            @endcan
                        </ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('customers_report') }}">تقارير العملاء</a></li>
						</ul>
					</li>
                    @endcan
                    @can('user-list')
